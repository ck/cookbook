...
Remember that we decided to use "RSpec":http://rspec.info/ for unit testing when we created out project. There are other good unit testing
...
First, lets define a helper module to make out life easier later. It contains all attributes to create a valid @Cook@ model
